...
def train_model(processed_dataset: ProcessedDataset, slm=SLM(batch_size=20)):
    ...
    train_dataset = list(zip(train_features, train_brothers, train_target_indices, train_targets))
    ...
    for epoch in range(Configuration.epochs_count):
        ...
        for batch_number, (x_batch, brothers_batch, indices_batch, y_batch) in enumerate(train_dataset):
